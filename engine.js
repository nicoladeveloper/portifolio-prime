// 💾 DADOS DOS PROJETOS (Preencha com seus dados reais e o caminho correto para as imagens)
const projetos = [
    {
        ...
        imagemUrl: "/Projetos/Natural Disaster Watch.jpg" 
    },
    {
        ...
        imagemUrl: "/Projetos/Kimetsu Memory.jpg" 
    },
    {
        nome: "Nome: (DataShow)",
        ...
        imagemUrl: "/Projetos/DataShow.jpg" 
    },
       {
        nome: "Nome: (AllGames)",
        ...
        imagemUrl: "/Projetos/AllGames.jpg" 
    }
];
...
/**
 * Função que renderiza todos os projetos do array 'projetos' na tela.
 */
...
// Inicializa a renderização dos projetos ao carregar a página
